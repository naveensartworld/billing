...
$sql=mysqli_query($con,"insert into Customers(first_name,last_name,email,password,phone,city,country,active,create_date) values('$first_name','$last_name','$email','$password','$phone','$city','$country','$active', '$date')");
...
<?php } ?>
			...
			<form class="form-horizontal row-fluid" name="insertCustomer" method="post" enctype="multipart/form-data">
				<div class="control-group">
					...
					<div class="controls">
						<input type="text"    name="first_name"  placeholder="Enter First Name" class="span8 tip" required>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text"    name="last_name"  placeholder="Enter LAst Name" class="span8 tip" required>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="basicinput">Email</label>
					<div class="controls">
						<input type="text"    name="email"  placeholder="Enter Email" class="span8 tip" required>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
					<input type="text"    name="country"  placeholder="Enter Country" class="span8 tip" required>
					</div>
				</div>
	...
	<div class="control-group">
		<div class="controls">
			<button type="submit" name="submit" class="btn">Add Customer</button>
		</div>
	</div>
	</form>
		</div>
