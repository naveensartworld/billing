                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="text-center">
                                        ...
                                        <?php $query=mysqli_query($con,"select * from periods order by row_id desc");
$cnt=1;
...
?>	
                                            <tr>
                                                ...
                                                <td><?php echo htmlentities($row['period_name']);?></td>
                                                <td><?php echo htmlentities($row['description']);?></td>
                                                <td><?php echo htmlentities($row['days']);?></td>
                                                <td><?php  if($row['active']=='1') { echo 'Active'; }  else { echo 'Inactive'; } ?></td>
                                                
                                                <td><a href="update_period.php?id=<?php echo encrypt($row['row_id']); ?>">Edit</a></td>
                                            </tr>
                                           <?php } ?>
                                        </tbody>
                                    </table>
