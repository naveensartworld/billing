            ...
            <div class="main-content-inner">
            	   <!-- Dark table start -->
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="header-title">Manage periods</h2>
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="text-center">
                                        ...
                                        <?php $query=mysqli_query($con,"select c.*,co.country_name from currencies as c left join countries as co on (co.row_id=c.country)  order by c.row_id desc");
$cnt=1;
...
?>	
                                            <tr>
                                                ...
                                                <td><?php echo htmlentities($row['currency_name']);?></td>
                                                <td><?php echo htmlentities($row['currency_code']);?></td>
                                                <td><?php echo htmlentities($row['country_name']);?></td>
                                                <td><?php  if($row['active']=='1') { echo 'Active'; }  else { echo 'Inactive'; } ?></td>
                                                
                                                <td><a href="update_currency.php?id=<?php echo encrypt($row['row_id']); ?>">Edit</a></td>
                                            </tr>
                                           <?php } ?>
                                        </tbody>
                                    </table>
