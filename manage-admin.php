                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="text-center">
                                        ...
                                        <?php $query=mysqli_query($con,"select * from admin_users");
$cnt=1;
...
?>	
                                            <tr>
                                                ...
                                                <td><?php echo htmlentities($row['admin_first_name']. ' ' . $row['admin_last_name']);?></td>
                                                ...
                                                <td><a href="edit-admin.php?id=<?php echo encrypt($row['row_id']); ?>">Edit</a> </td>
                                            </tr>
                                           <?php } ?>
                                        </tbody>
                                    </table>
