            ...
            <div class="main-content-inner">
            	   <!-- Dark table start -->
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="header-title">Manage Product Types</h2>
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="text-center">
                                        ...
                                        <?php $query=mysqli_query($con,"select * from producttypes order by row_id desc");
$cnt=1;
...
?>	
                                            <tr>
                                                ...
                                                <td><a href="update_product_type.php?id=<?php echo encrypt($row['row_id']); ?>">Edit</a></td>
                                            </tr>
                                           <?php } ?>
                                        </tbody>
                                    </table>
