                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="text-center">
                                        ...
                                        <?php $query=mysqli_query($con,"select * from products order by row_id desc");
$cnt=1;
...
?>	
                                            <tr>
                                                ...
                                                <td><?php echo htmlentities($row['prd_name']);?></td>
                                                <td><?php echo htmlentities(dateFormat($row['start_date']));?></td>
												<td><?php echo htmlentities(dateFormat($row['end_date']));?></td>
												<td><?php echo htmlentities($row['default_price']);?></td>
                                                <td><?php  if($row['active']=='1') { echo 'Active'; }  else { echo 'Inactive'; } ?></td>
                                                <td><a href="update-product.php?id=<?php echo encrypt($row['row_id']); ?>">Edit</a></td>
                                            </tr>
                                           <?php } ?>
                                        </tbody>
                                    </table>
